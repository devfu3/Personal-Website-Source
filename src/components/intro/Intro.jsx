    ...
    <div className="i">
        <div className="i-left">
                <div className="i-left-wrapper">
                    ...
                    <h1 className="i-name">Devin Fu</h1>
                    <div className="i-title">
                        <div className="i-title-wrapper">
                        <div className="i-title-item">Health Science Specialist</div>
                        <div className="i-title-item">Study Coordinator</div>
                        <div className="i-title-item">Researcher</div>
                        <div className="i-title-item">Writer</div>
                        <div className="i-title-item">Novice Web Developer</div>
                        <div className="i-title-item">Gamer</div>
                        </div>
                    </div>
                    <p className="i-desc">
                        I work in behavioral and clinical research trials regarding Chronic Kidney Disease (CKD) for 
                        the United States Department of Veterans' Affairs. My hobbies include video games, cooking, 
                        listening to and mixing music, as well as consuming alarming amounts of caffeine.
                    </p>
                </div>
                <svg 
                width="400px" 
